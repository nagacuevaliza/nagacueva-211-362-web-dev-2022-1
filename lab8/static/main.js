...
let intersectionsList = document.querySelector(".intersections"); // -- Список с элементами совпадения 
...
window.onload = function () {
    ...
    document.querySelector(".search-btn").onclick = downloadData; // -- Кнопка "Найти"
}